...
/**
  ...
  * @retval  #TETHERING_ERROR_NOT_SUPPORT_API  API not supported
  * @retval  #TETHERING_ERROR_PERMISSION_DENIED  Permission Denied
  * @see tethering_wifi_ap_get_max_connected_device()
  */
 ...
 * @retval  #TETHERING_ERROR_NOT_SUPPORT_API  API not supported
 * @retval  #TETHERING_ERROR_PERMISSION_DENIED  Permission Denied
  * @see tethering_wifi_ap_set_max_connected_device()
  */
 ...
 * @retval  #TETHERING_ERROR_PERMISSION_DENIED  Permission Denied
 */
int tethering_wifi_ap_enable_port_filtering(tethering_h tethering, bool enable);
